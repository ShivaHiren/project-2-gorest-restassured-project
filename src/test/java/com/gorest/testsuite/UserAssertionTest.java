...
public class UserAssertionTest extends TestBase {
    ...
    @Test
    public void test002() {
        response.body("find{it.id==5240}.name",equalTo("Aanjaneya Banerjee"));
    }
    ...
    @Test
    public void test004() {
        response.body("name",hasItems("Bhilangana Shah","Ganak Jain","Nirbhay Khan"));
    }
    ...
    @Test
    public void test005() {
        response.body("find{it.id==5231}.name",equalTo("Chaitan Chaturvedi"));
    }
    //6.Verify the status is “Active” of user name is “Ganak Jain”
    @Test
    public void test006() {
        response.body("find{it.name=='Chaitan Chaturvedi'}.status",equalTo("active"));
    }
